...
var _user$project$ChordDiagrams_View$hasNote = F2(
	function (string, fingering) {
		...
		switch (_p0.ctor) {
			case 'Single':
				return _elm_lang$core$Native_Utils.eq(_p0._0.string, string);
			case 'Barred':
				var _p1 = _p0._0;
				return (_elm_lang$core$Native_Utils.cmp(string, _p1.startString) < 0) ? false : ((_elm_lang$core$Native_Utils.cmp(string, _p1.endString) > 0) ? false : true);
			default:
				return false;
		}
	});
	...
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$svg$Svg_Attributes$cx(xcoord),
					_1: {
						ctor: '::',
						_0: _elm_lang$svg$Svg_Attributes$cy(ycoord),
						_1: {
							ctor: '::',
				...
				_0: A2(
					...
					},
					{
						...
						_0: _elm_lang$html$Html$text(
							_elm_lang$core$Basics$toString(note.finger)),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			}
			...
			_1: {
				...
				_0: A2(
					_elm_lang$svg$Svg$text_,
					{
						...
						_1: {
							...
							_1: {
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$svg$Svg_Attributes$dx(labelX),
									_1: {
										ctor: '::',
					...
					},
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text(
							_elm_lang$core$Basics$toString(barre.finger)),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
		...
		_1: {
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('source code on '),
						_1: {
							ctor: '::',
							_0: A2(
								_elm_lang$html$Html$a,
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$href('https://github.com/veddermatic/elm-dimeola'),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
